<?php
    ...
    use projeto\projetoesta\php\controllerGerente;
?>
        ...
        <body>
            ...
            <form method="POST">
                ...
                try{ 
                    ...
                    $_SESSION['gCodigo'] = $codigo;
                    $_SESSION['gNome'] = $nome;
                    $_SESSION['gDataNascimento'] = $dataNascimento;
                    $_SESSION['gTelefone'] = $telefone;
                    $_SESSION['gEndereco'] = $endereco;
                    $_SESSION['gSalario'] = $salario;
                    $_SESSION['gCargo'] = $cargo;

                    $gerente1 = new Gerente($codigo, $nome, $dataNascimento, $telefone, $endereco, $salario, $cargo);
